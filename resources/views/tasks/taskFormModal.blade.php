<!-- Modal -->
<div class="modal fade" id="taskFormModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                    ...
                                    <div class="vstack gap-3">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <input type="checkbox" class="btn-check" id="js0"
                                                name="taskItem[0][js]">
                                            <label class="btn btn-outline-info text-dark" for="js0">JavaScript</label>
